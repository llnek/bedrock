...
class MockConnection(private val _uid:String,private val _pwd:String) extends Connection {
  ...
  def createConnectionConsumer(dest:Destination,
      a1:String, pool:ServerSessionPool, a3:Int) = null

  def createDurableConnectionConsumer(topic:Topic,
      a1:String, a2:String, pool:ServerSessionPool, a4:Int) = null
