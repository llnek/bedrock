...
class UriMatrixDecoder(private val _uri:String, private val _charset:String="utf-8") {
  ...
  private var _params:Map[String,StrArr]= _ 
  ...
  private def decodeParams(s:String) = {
    var params = LinkedHashMap[String, StrArr]()
  ...
  private def addParam( params:LinkedHashMap[String,StrArr], name:String, value:String) {
    params.get(name) match {
      case None => params += name ->  StrArr()
    }
